...
var Note = React.createClass({displayName: "Note",
	...
	renderDisplay: function () {
		return (
			React.createElement("article", {className: "note draggable", 
				style: this.style}, 
				React.createElement("p", null, this.props.children), 
				React.createElement("img", {src: "assets/rabduck.gif", alt: "an optical illusion appearing to be either a rabbit or a duck", className: "illusion"}), 
				React.createElement("span", {className: "button-bar"}, 
	...
	renderForm: function () {
		return (
			React.createElement("article", {className: "note", 
				style: this.style}, 
